...
function FlashNewsCard({ newsDetail }) {
  ...
  return (
    <div
      ...
      className="border-[#F1F1F1] border-[1.5px] shadow-2xs relative rounded-[10px] overflow-hidden max-w-[416px] flex flex-col  items-center justify-center p-4 gap-5 duration-300 ease-out hover:bg-[#e3e3e3]/20 hover:shadow-lg hover:border-0 transition-colors   "
    >
      <img
      ...
      <div
        className={`bg-primary w-full h-14 absolute  bottom-0 z-10 transition-all duration-500 ease-in-out ${
          isHovered
